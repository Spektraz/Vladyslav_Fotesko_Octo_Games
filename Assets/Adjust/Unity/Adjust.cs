...
namespace com.adjust.sdk
{
    public class Adjust : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                Debug.Log("HERE");
              //  var logLevel = ApplicationContainer.Instance.IsDebugMode ? AdjustLogLevel.Verbose : AdjustLogLevel.Info;
               // var environment = ApplicationContainer.Instance.IsDebugMode ? AdjustEnvironment.Sandbox : AdjustEnvironment.Production;
                ...
                Debug.Log($"[Adjust] Config environment = {adjustConfig.environment}, log level = {adjustConfig.logLevel}");
